   ...
   /* public void onBackPressed() {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_view) {
            ...
            startActivity(new Intent(PatientInfoActivity.this, SettingsActivity.class));

        } else if (id == R.id.nav_notes) {
            startActivity(new Intent(PatientInfoActivity.this, FragmentNotes.class));

        } else if (id == R.id.nav_patientInfo) {
            startActivity(new Intent(PatientInfoActivity.this, PatientInfoActivity.class));

        } else if (id == R.id.nav_adinfo) {
            startActivity(new Intent(PatientInfoActivity.this, AdInfoActivity.class));
