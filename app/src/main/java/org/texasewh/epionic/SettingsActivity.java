...
public class SettingsActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_main) {
            ...
            startActivity(new Intent(SettingsActivity.this, FragmentNotes.class));

        } else if (id == R.id.nav_patientInfo) {
            startActivity(new Intent(SettingsActivity.this, PatientInfoActivity.class));

        } else if (id == R.id.nav_adinfo) {
            startActivity(new Intent(SettingsActivity.this, AdInfoActivity.class));
